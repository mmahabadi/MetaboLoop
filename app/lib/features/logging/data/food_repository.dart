...
class FoodRepository {
  ...
  Future<void> cacheFood(LocalFood food) {
    return _db.upsertFood(
      LocalFoodsCompanion.insert(
        ...
        fiberPer100gGrams: Value(food.fiberPer100gGrams),
        sugarPer100gGrams: Value(food.sugarPer100gGrams),
        sodiumPer100gMg: Value(food.sodiumPer100gMg),
  ...
  Future<LocalFood> createCustomFood({
    ...
    double? fiberPer100gGrams,
    double? sugarPer100gGrams,
    double? sodiumPer100gMg,
  ...
  LocalFood _toUncachedLocalFood(OffProduct product) {
    return LocalFood(
      ...
      fiberPer100gGrams: product.fiberPer100gGrams,
      sugarPer100gGrams: product.sugarPer100gGrams,
      sodiumPer100gMg: product.sodiumPer100gMg,
